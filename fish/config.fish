...
set -g -x PATH $PATH /opt/flutter/bin $HOME/.local/bin $HOME/.cargo/bin $HOME/.android/sdk/tools/bin $HOME/.yarn/bin $HOME/.config/composer/vendor/bin $HOME/.pub-cache/bin $HOME/.go/bin

set -U FZF_LEGACY_KEYBINDINGS 0 # https://github.com/jethrokuan/fzf

alias vim='nvim'
alias ls='ls --color -h --group-directories-first'
alias ll='ls --color -h --group-directories-first -Al'
